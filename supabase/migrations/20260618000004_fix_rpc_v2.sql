-- Rewrite demo_gen_orders with ultra-conservative type casting
...
BEGIN
  ...
  LOOP
    ...
    FOR v_i IN 1..(v_num_orders * 0.55)::int LOOP
      ...
      -- Insert order first (FK from items needs it)
      ...
      VALUES (v_order_id, p_venue_id, v_shift_id, v_wid, v_tid, v_order_num::text, v_stat, 0, v_ts, v_ts2, 1 + (random()*3)::int, v_tnum);
      ...
      IF v_stat = 'paid' THEN
        ...
        INSERT INTO payments (order_id, shift_id, venue_id, method, amount, created_at) VALUES (v_order_id, v_shift_id, p_venue_id, v_meth::payment_method, v_total, v_ts2);
    ...
    VALUES (v_shift_id, p_venue_id, v_cid, v_shift_start, v_shift_end, v_sc, v_shift_cnt, v_shift_rev, floor(v_shift_rev * 0.6), ceil(v_shift_rev * 0.4), v_ec, v_diff, 0);
    INSERT INTO cash_movements (venue_id, shift_id, movement_type, amount, note, occurred_at) VALUES (p_venue_id, v_shift_id, 'float_in', v_sc, 'opening_balance', v_shift_start);
